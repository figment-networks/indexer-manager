...
import (
	...
	"github.com/figment-networks/indexer-manager/cmd/scheduler/config"

	"github.com/figment-networks/indexer-manager/scheduler/core"
	...
	"github.com/figment-networks/indexer-manager/scheduler/persistence/postgresstore"
	"github.com/figment-networks/indexer-manager/scheduler/process"
	"github.com/figment-networks/indexer-manager/scheduler/runner/lastdata"
	runnerHTTP "github.com/figment-networks/indexer-manager/scheduler/runner/transport/http"
